    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) =
            uniffiRustCall { status ->
                ...
                UniffiLib.ffi_mouser_ffi_rustbuffer_alloc(size.toLong(), status)
            }.also {
                if (it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) =
            uniffiRustCall { status ->
                UniffiLib.ffi_mouser_ffi_rustbuffer_free(buf, status)
            }
    }
...
internal object IntegrityCheckingUniffiLib {
    init {
        Native.register(IntegrityCheckingUniffiLib::class.java, findLibraryName(componentName = "mouser_ffi"))
        uniffiCheckContractApiVersion(this)
        uniffiCheckApiChecksums(this)
    }

    external fun uniffi_mouser_ffi_checksum_method_mobileclient_connect(): Int

    external fun uniffi_mouser_ffi_checksum_method_mobileclient_device_id(): Int
    ...
    external fun uniffi_mouser_ffi_checksum_method_mobileclient_send_key(): Int
    ...
    external fun ffi_mouser_ffi_uniffi_contract_version(): Int
}
...
internal object UniffiLib {
    ...
    init {
        Native.register(UniffiLib::class.java, findLibraryName(componentName = "mouser_ffi"))
    }

    external fun uniffi_mouser_ffi_fn_clone_mobileclient(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    external fun uniffi_mouser_ffi_fn_free_mobileclient(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
    ...
    external fun uniffi_mouser_ffi_fn_method_mobileclient_device_id(
        `ptr`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    external fun uniffi_mouser_ffi_fn_method_mobileclient_disconnect(
        `ptr`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
    ...
    external fun uniffi_mouser_ffi_fn_method_mobileclient_send_button(
        `ptr`: Long,
        `button`: Byte,
        `down`: Byte,
        uniffi_out_err: UniffiRustCallStatus,
    ...
    external fun uniffi_mouser_ffi_fn_method_mobileclient_send_key(
        `ptr`: Long,
        `usage`: Short,
        `down`: Byte,
        `mods`: Short,
    ...
    external fun uniffi_mouser_ffi_fn_method_mobileclient_send_pointer_moved(
        `ptr`: Long,
        `displayId`: Int,
        `x`: Int,
        `y`: Int,
    ...
    external fun uniffi_mouser_ffi_fn_method_mobileclient_send_scroll(
        `ptr`: Long,
        `dx`: Int,
        `dy`: Int,
        uniffi_out_err: UniffiRustCallStatus,
    ...
    external fun ffi_mouser_ffi_rustbuffer_alloc(
        `size`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    external fun ffi_mouser_ffi_rustbuffer_from_bytes(
        `bytes`: ForeignBytes.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    external fun ffi_mouser_ffi_rustbuffer_free(
        `buf`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    external fun ffi_mouser_ffi_rustbuffer_reserve(
        `buf`: RustBuffer.ByValue,
        `additional`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    external fun ffi_mouser_ffi_rust_future_poll_u8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_u8(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_u8(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_u8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    external fun ffi_mouser_ffi_rust_future_poll_i8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_i8(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_i8(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_i8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    external fun ffi_mouser_ffi_rust_future_poll_u16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_u16(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_u16(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_u16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    external fun ffi_mouser_ffi_rust_future_poll_i16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_i16(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_i16(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_i16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Short

    external fun ffi_mouser_ffi_rust_future_poll_u32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_u32(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_u32(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_u32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    external fun ffi_mouser_ffi_rust_future_poll_i32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_i32(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_i32(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_i32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    external fun ffi_mouser_ffi_rust_future_poll_u64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_u64(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_u64(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_u64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    external fun ffi_mouser_ffi_rust_future_poll_i64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_i64(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_i64(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_i64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    external fun ffi_mouser_ffi_rust_future_poll_f32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_f32(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_f32(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_f32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Float

    external fun ffi_mouser_ffi_rust_future_poll_f64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_f64(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_f64(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_f64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Double

    external fun ffi_mouser_ffi_rust_future_poll_rust_buffer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_rust_buffer(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_rust_buffer(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_rust_buffer(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    external fun ffi_mouser_ffi_rust_future_poll_void(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    external fun ffi_mouser_ffi_rust_future_cancel_void(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_free_void(`handle`: Long): Unit

    external fun ffi_mouser_ffi_rust_future_complete_void(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
}
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_mouser_ffi_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_mouser_ffi_checksum_method_mobileclient_send_button() != 37969) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mouser_ffi_checksum_method_mobileclient_send_key() != 56450) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mouser_ffi_checksum_method_mobileclient_send_pointer_moved() != 37151) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface MobileClientInterface {
     ...
     */
    fun `sendPointerMoved`(
        `displayId`: kotlin.UInt,
        `x`: kotlin.Int,
        `y`: kotlin.Int,
    )
...
open class MobileClient :
    ...
    constructor() :
        this(
            ...
            uniffiRustCall { _status ->
                UniffiLib.uniffi_mouser_ffi_fn_constructor_mobileclient_new(_status)
            },
        )
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_mouser_ffi_fn_free_mobileclient(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall { status ->
            UniffiLib.uniffi_mouser_ffi_fn_clone_mobileclient(handle, status)
        }
    }
    ...
    override fun `deviceId`(): kotlin.String =
        FfiConverterString.lift(
            callWithHandle {
                uniffiRustCall { _status ->
                    UniffiLib.uniffi_mouser_ffi_fn_method_mobileclient_device_id(
                        it,
                        _status,
                    )
                }
    ...
    override fun `disconnect`() =
        callWithHandle {
            uniffiRustCall { _status ->
                UniffiLib.uniffi_mouser_ffi_fn_method_mobileclient_disconnect(
                    it,
                    _status,
                )
            }
    ...
    override fun `isConnected`(): kotlin.Boolean =
        FfiConverterBoolean.lift(
            callWithHandle {
                uniffiRustCall { _status ->
                    UniffiLib.uniffi_mouser_ffi_fn_method_mobileclient_is_connected(
                        it,
                        _status,
                    )
                }
    ...
    override fun `sendButton`(
        ...
        uniffiRustCall { _status ->
            UniffiLib.uniffi_mouser_ffi_fn_method_mobileclient_send_button(
                it,
                FfiConverterUByte.lower(`button`),
                FfiConverterBoolean.lower(`down`),
                _status,
            )
        }
    }
    ...
    override fun `sendKey`(
        ...
        uniffiRustCall { _status ->
            UniffiLib.uniffi_mouser_ffi_fn_method_mobileclient_send_key(
                it,
                FfiConverterUShort.lower(`usage`),
                FfiConverterBoolean.lower(`down`),
                FfiConverterUShort.lower(`mods`),
                _status,
            )
        }
    }
     ...
     * absolute result to its real display.
     */
    override fun `sendPointerMoved`(
        `displayId`: kotlin.UInt,
        `x`: kotlin.Int,
        `y`: kotlin.Int,
    ) = callWithHandle {
        uniffiRustCall { _status ->
            UniffiLib.uniffi_mouser_ffi_fn_method_mobileclient_send_pointer_moved(
                it,
                FfiConverterUInt.lower(`displayId`),
     ...
     * Report a scroll delta in logical pixels.
     */
    override fun `sendScroll`(
        `dx`: kotlin.Int,
        `dy`: kotlin.Int,
    ) = callWithHandle {
        uniffiRustCall { _status ->
            UniffiLib.uniffi_mouser_ffi_fn_method_mobileclient_send_scroll(
                it,
                FfiConverterInt.lower(`dx`),
                FfiConverterInt.lower(`dy`),
                _status,
            )
        }
    }
...
sealed class MobileException : kotlin.Exception() {
     ...
     */
    class InvalidPeerId : MobileException() {
     ...
     */
    class AlreadyConnected : MobileException() {
        override val message
            get() = ""
    }
     ...
     */
    class NotConnected : MobileException() {
        override val message
            get() = ""
    }
...
public object FfiConverterTypeMobileError : FfiConverterRustBuffer<MobileException> {
    override fun read(buf: ByteBuffer): MobileException =
        when (buf.getInt()) {
            1 -> {
                MobileException.InvalidPeerId()
            }

            2 -> {
                MobileException.AlreadyConnected()
            }

            3 -> {
                MobileException.NotConnected()
            }

            4 -> {
                MobileException.Bind(
                    FfiConverterString.read(buf),
                )
            }

            5 -> {
                MobileException.Connect(
                    FfiConverterString.read(buf),
                )
            }
    ...
    override fun allocationSize(value: MobileException): ULong =
        when (value) {
            is MobileException.InvalidPeerId -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )

            is MobileException.AlreadyConnected -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )

            is MobileException.NotConnected -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )

            is MobileException.Bind -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
                    FfiConverterString.allocationSize(value.`detail`)
            )

            is MobileException.Connect -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
                    FfiConverterString.allocationSize(value.`detail`)
            )
